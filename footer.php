            ...
            <div class="col-lg-3">
                <div class="d-flex justify-content-lg-center p-4" style="background: rgba(256, 256, 256, .05);">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="m-0">Portugal: Lisboa Centro 5 outubro 125</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="d-flex justify-content-lg-center p-4" style="background: rgba(256, 256, 256, .05);">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="m-0">info@bigtasklawfirm.com</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h4 class="m-0 mt-n2 display-7 text-primary text-uppercase">BIG TASK LAW FIRM</h4>
                </a>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
                 <h4 class="font-weight-semi-bold text-primary mb-4">Branches</h4>
                <div class="d-flex flex-column justify-content-start">
                    <i class="fa fa-angle-right mr-2">USA: 1616 E 56th St,Chicago IL 60637</i> 
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>Subscribe to our email list to receive update on legal system</p>
                <div class="w-100">
