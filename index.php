...
?>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-5">
                    <img class="img-fluid rounded" src="img/fourth.jpg" alt="">
                </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <p>We provide the general public with the best and genuine services</p>
                    <a href="services.php" class="btn btn-primary mt-2">More Services</a>
                </div>
                <div class="col-lg-9 pt-5 pt-lg-0">
                    ...
                    <div class="owl-carousel service-carousel position-relative" style="margin-top: -100px; padding: 0 30px;">
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            ...
                            <p class="m-0">I have participated in over one-hundred mediation sessions in cases involving a wide range of civil litigation and domestic relations issues. I have completed an intensive 40 hour Supreme Court certified mediation training program and also am a registered mediator in Indiana. I know how meditation works and how it can help you resolve your case</p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <p class="m-0">You might begin by looking for family law solicitors. However, family law solicitors will charge you by the hour as family law solicitors have set price procedures in place. As we are legal consultants and deal only with specialist Barristers, we provide you with set prices for every aspect of work we carry out for you</p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                            ...
                            <p class="m-0">The lawyers in our business services team will support you with commercial advice on all aspects of running your business, on the contracts which you already have in place and on those which need to be drafted</p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-4">
                        They treated my case with speciality and won the case as well
                    </div>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-4">
                        I won my cuybersecurity case with the help of bigtasklawfirm.com
                    </div>
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/testimonial-2.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Eric Ockran</h5>
                            <p class="m-0">Cybersecurity Specialist</p>
                        </div>
                    </div>
                </div>
